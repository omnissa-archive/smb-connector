...
while IFS='' read -r line || [[ -n "$line" ]]; do
    ...
    ulimit -c unlimited
    nohup /opt/omnissa/content-gateway/smb-connector/smbconnector -m client -s $line -l client$log_count.log -o $3 -g 4 -u $url -n $user -p $pass -w $wg --out_file=out$log_count > client.dat &
